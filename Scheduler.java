...
public class Scheduler {
    /**
     * this class that servers as context for all possible scheduling strategies. We
     * can assign any scheduling strategy to this scheduler class and it will
     * happily execute that strategy. Each Scheduler is assigned its own
     * communicator class which helps to facilitate the lower level communication
     */
    ...
    Scheduler(String inIp, String inPort) {
        ip = inIp;
        port = inPort;
    ...
    public void executeScheduler() {
        ...
        communicator.start(ip,port);
        scheduler.schedule();
        communicator.quit(null, false);
    }
}
